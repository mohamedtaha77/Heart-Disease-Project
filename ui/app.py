...
def user_input():
    ...
    # Assemble numeric features in correct column order
    data = {
...
if st.button("Predict"):
    ...
    # Ensure prediction is a plain int (not numpy.int64 or array)
    ...
    st.success(f"🏷️ Predicted Heart Disease Class: {pred_class} — {disease_labels[pred_class]}")
